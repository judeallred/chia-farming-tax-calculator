...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/chia-farming-tax-calculator.git`
...
- **`npm run update-prices`** — Regenerate bundled price data
...
- `src/services/` — API clients, caching, address codec
