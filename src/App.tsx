      ...
      <header className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-5xl px-4 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Chia Farming Tax Calculator</h1>
              <p className="text-sm text-gray-500">Calculate cost basis for XCH farming income</p>
            </div>
          </div>
        </div>
      </header>
